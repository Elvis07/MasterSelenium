...
public class SeleniumTest {
	...
	String number="97564765";
	 //@Parameters( { "url", "query-string", "btn-id", "txt-id", "verify-String" }) 按先后顺序
	@Parameters("browser")
	@BeforeTest
...
//			driver = new InternetExplorerDriver();
	...
	public void test() {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.id("tracing_by_booking_f:hl10")));//等待网页响应完成，这里以Booking No.的label出现算ok
