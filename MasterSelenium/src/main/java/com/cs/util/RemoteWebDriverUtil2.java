...
public class RemoteWebDriverUtil2 {
...
//		sCaps.setCapability(CapabilityType.PROXY, p);
		...
		((PhantomJSDriver) driver)
				.executePhantomJS("this.onResourceRequested = function(requestData, request){"
						+
						// "   if ((/http:\\/\\/.+?olb\\.js).test(requestData['url']) || requestData['Content-Type'] == 'text/css') {"
						// +
						// "   console.log('The url of the request is matching. Aborting: ' + requestData['url']);"
						// +
						// "   request.abort();" +
						// "   }" +
						"   if (requestData.url.indexOf('olb.js') != -1|"
						+ "requestData.url.indexOf('.css') != -1|"
						+ "requestData.url.indexOf('.gif') != -1|"
						+ "requestData.url.indexOf('t.js') != -1|"
						+ "requestData.url.indexOf('woff') != -1|"
						+ "requestData.url.indexOf('svg') != -1|"
						+ "requestData.url.indexOf('cnt') != -1|"
						+ "requestData.url.indexOf('even') != -1|"
						+ "requestData.url.indexOf('webE') != -1|"
