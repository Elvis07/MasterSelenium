...
//			String host = Loader.suite.getCases().get(i).getHost();
//			String browser = Loader.suite.getCases().get(i).getBrowser();
//			driverList.add(getDriver(browser,host));
//		}
//	}
//
//	private static WebDriver getDriver(String browser,String host) {
//		WebDriver driver = null;
//		if (browser.contains("chrome")) {
//			driver = getChromeDriver(host);
//		} else if (browser.contains("firefox")) {
//			driver = getFirefoxDriver(host);
//		}
//		return driver;
//	}
//
